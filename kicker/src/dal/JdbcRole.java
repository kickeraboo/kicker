...
public class JdbcRole implements RoleDao {
	 ...
	 * 
	 * @param newRole
	 *            The role instance to be inserted.
	...
	public Role createRole(Role newRole) {
		...
		query = String
				.format(query, newRole.getRoleName(), newRole.getStatus());
	...
	/**
	 * getRoleByName retrieves a role from the database.
	 * 
	 * @param roleName is type of role in the database going to be retrieved.
	 * 
	 * @return Returns a role object from the database.
	 */
	@Override
	 ...
	 * 
	 * @param newRole
	 *            The role instance to be updated.
	 ...
	 * 
	 * @param oldRole
	 *            The role instance to be deleted.
	 * @return Returns true if the role was deleted and false if the role was
	 *         not deleted.
	 */
	@Override
	 ...
	 * 
	 * @param roleId
	 *            The id of the role to be deleted in the database.
	 * @return Returns true if the role was deleted and false if the role was
	 *         not deleted.
	 */
	@Override
	...
	/**
	 * convertResultSetToRole for lack of implicit/explicit operators, we
	 * manually convert a row in the result set, into an role.
	 * 
	 * @param rs
	 *            The result set to convert into a Role object.
