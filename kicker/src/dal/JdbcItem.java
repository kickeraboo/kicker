...
public class JdbcItem implements ItemDao
{
    ...
    * @param newItem The item instance to be inserted.
    ...
    * @param newItem The item instance to be updated.
    ...
    * @param oldItem The item instance to be deleted.
    * @return Returns true if the item was deleted and false if the item was not deleted.
    */
      @Override
   ...
   /**
    * deleteItem Deletes a item from the database.
    * @param itemId The id of the item to be deleted in the database.
    * @return Returns true if the item was deleted and false if the item was not deleted.
    */
      @Override
   ...
   /**
    * convertResultSetToItem for lack of implicit/explicit operators, we manually convert a row in the result set, into an item.
    * @param rs The result set to convert into a Item object.
